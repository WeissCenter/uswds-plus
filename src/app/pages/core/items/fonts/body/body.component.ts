...
export class FontBodyComponent {
  tokenForm!: FormGroup;
  ...
  applyStyles() {
    ...
    this.tokenToCssService.injectCssStyleTag(css, 'body-font');
  }

 

  resetStyles() {
    const styleTag = document.getElementById('body-font') as HTMLStyleElement;
    if (styleTag) {
      styleTag.innerHTML = '';
    }
  }
