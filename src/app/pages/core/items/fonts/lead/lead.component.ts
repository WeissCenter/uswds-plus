...
export class FontLeadComponent {
  tokenForm!: FormGroup;
  ...
  applyStyles() {
    ...
    this.tokenToCssService.injectCssStyleTag(css, 'lead-font');
  }

 

  resetStyles() {
    const styleTag = document.getElementById('lead-font') as HTMLStyleElement;
    if (styleTag) {
      styleTag.innerHTML = '';
    }
  }
